...
function buildPrompt({ country, contentType, category, language, businessName, city, rating }) {
  ...
  const targets = {
    ...
    'Instagram DM': `Write a cold Instagram DM in ${lang} to ${biz} in ${country}. STRICTLY follow this structure - no deviation: Sentence 1: Compliment ${biz} specifically by name. Sentence 2: Our AI agent replies to all WhatsApp inquiries automatically 24/7 in any language - never miss a booking. Sentence 3: Free 30-day trial, no contract. Sign off: Muzafar — +1 (307) 886-8139 or wa.me/13078868139. RULES: Maximum 3 sentences + sign off. NO hashtags. NO emojis except one at end. If Albanian use ë and ç.`
  };
