...
function buildPrompt({ country, contentType, category, language, businessName, city, rating }) {
  ...
  const targets = {
    ...
    'Instagram DM': `You are a sales rep visiting ${country}. Write a cold Instagram DM to ${biz}. MUST mention "${biz}" by name in the opening. Language: ${lang}. Structure: 1) Open by complimenting something specific about ${biz} and mention their name. 2) One sentence: our AI agent replies to WhatsApp inquiries 24/7 in any language automatically. 3) Offer 30-day free trial, close with: Muzafar — WhatsApp: +1 (307) 886-8139 wa.me/13078868139. MAX 3 sentences. Casual, warm, no hashtags. If Albanian use ë and ç characters.`
  };
